...
void loop(){
MoveCube90AntiClockwise();FlickOverCube();RotateCube90Clockwise();MoveCube180();FlickOverCube();RotateCube90AntiClockwise();FlickOverCube();RotateCube90Clockwise();FlickOverCube();RotateCube90Clockwise();
